...
export class AppComponent implements AfterViewInit {
  ...
  @ViewChild('libraryComponent') libraryComponent!: ElementRef;

  ngAfterViewInit(): void {
    // Ensure libraryComponent is available after view initialization
    if (!this.libraryComponent) {
      console.error('LibraryComponent is not available.');
    }
  }
