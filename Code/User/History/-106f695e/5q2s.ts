...
function savePreset(name: string, preset: Preset, extensionPath: string): Promise<void> {
    return new Promise((resolve, reject) => {
        ...
        try {
            ...
            const editor = preset.editorColor;
            const sidebar = preset.sidebarColor;
            const panel = preset.panelColor;
            const statusBar = preset.statusBarColor;
            const tabs = preset.tabsColor;
            const tokenColors = JSON.stringify(themeData.tokenColors);
