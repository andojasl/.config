...
const getWorkbenchColors = () => {
    ...
    const editorBackground = colorCustomizations['editor.background'] || 'default';
    const sideBarBackground = colorCustomizations['sideBar.background'] || 'default';
    const panelBackground = colorCustomizations['panel.background'] || 'default';
    const statusBarBackground = colorCustomizations['statusBar.background'] || 'default';
    const tabsBackground = colorCustomizations['editorGroupHeader.tabsBackground'] || 'default';
