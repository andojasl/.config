...
void trafficLightTask(void *parameter)
{
    ...
    while (true)
    {
        ...
        int i = 0;
        while (xSemaphoreTake(buttonSemaphore, portMAX_DELAY) != pdTRUE || i == 20)
        {
        ...
        Serial.println("Button press detected. Changing lights...");
        changeLights(); // Perform the light change sequence
