...
### Plan
- Week 1-5: Finding idea, reaching out to stakeholders, doing team meetings every week to discuss further steps, started researching productivity techniques. [Pomodoro](https://todoist.com/productivity-methods/pomodoro-technique) | [Pomodoro video](https://www.youtube.com/watch?v=1l4w7uHdNaQ) | [Eisenhower Matrix](https://slab.com/blog/eisenhower-matrix/)
- Week 6: Meeting regularly to define the idea, meeting with project coach to discuss the process, writing/presenting the pitch. [Pitch](https://github.com/FontysVenlo/prj4-grouprepository-prj4s-01/blob/main/Pitch.md)
